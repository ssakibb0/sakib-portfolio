...
//         {
//           from_name: form.name,
//           to_name: 'Mohd Sakib Shaikh', // put your name here.
//           from_email: form.email,
//           to_email: 'mohdsakib8085@gmail.com', //put your email here.
...
const Contact = () => {
  ...
  //       {
  //         from_name: form.name,
  //         to_name: 'Mohd Sakib Shaikh',
  //         from_email: form.email,
  //         to_email: 'mohdsakib8085@gmail.com',
  //         message: form.message,
  //       },
  //       'HL5Xt3ymbsibD1FLC' // public key
  //     )
  //     .then(
  //       () => {
  //         setLoading(false);
    ...
    <div className="-mt-[8rem] xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        <form
          ...
          <button
            type="submit"
            className="live-demo flex justify-center sm:gap-4 gap-3 sm:text-[20px] text-[16px] text-timberWolf 
            font-bold font-beckman items-center py-5
            whitespace-nowrap sm:w-[130px] sm:h-[50px] 
            w-[100px] h-[45px] rounded-[10px] bg-night 
            hover:bg-battleGray hover:text-eerieBlack 
